  ...
  return (
    <section className="tpservices-area pt-115 pb-85 p-relative">
        <div className="container">
          ...
          {select_services?.length ? (
          <div className="row mt-60">
             {select_services?.map(serviceItem => (
            <div key={serviceItem.ID} className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
              <div className="tpservices tpservices-2 text-center mb-30">
                <div className="tpservices__icon mb-30">
                  <i className={serviceItem?.custom_field?.icon_class}></i>                      
                </div>
